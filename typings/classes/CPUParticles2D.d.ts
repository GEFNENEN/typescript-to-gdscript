...
declare class CPUParticles2D extends Node2D {
  ...
  set_direction(value: Vector2 | Vector2i): void;
  get_direction(): Vector2;
  set_draw_order(value: int): void;
  get_draw_order(): int;
  set_emission_colors(value: PackedColorArray | Array<unknown>): void;
  get_emission_colors(): PackedColorArray;
  set_emission_normals(value: PackedVector2Array | Array<unknown>): void;
  get_emission_normals(): PackedVector2Array;
  set_emission_points(value: PackedVector2Array | Array<unknown>): void;
  get_emission_points(): PackedVector2Array;
  set_emission_rect_extents(value: Vector2 | Vector2i): void;
